...
#
# Usage:
#   bash aha_home_train_single_daily.sh 20260529 v1 4
#   bash aha_home_train_single_daily.sh 20260530 v1 4
#   bash aha_home_train_single_daily.sh 20260601 v1 4
#
# Args:
#   $1  day         — date string, e.g. 20260529
#   $2  model_name  — model identifier, e.g. v1 / v2_test
#   $3  num_workers — DataLoader worker count
#
...
DAY="${1:?Usage: $0 <day> <model_name> <num_workers>}"
MODEL_NAME="${2:?Usage: $0 <day> <model_name> <num_workers>}"
NUM_WORKERS="${3:?Usage: $0 <day> <model_name> <num_workers>}"
...
# Look for ckpt_<model>_*.pt with date < DAY
